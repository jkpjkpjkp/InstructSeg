...
from instructseg.datasets.InstructSegDatasets import DataCollatorForCOCODatasetV2, Reason_dataset_test
...
def evaluation():
    ...
    val_data_list = ['ReasonSeg|val',]

    for val_data in val_data_list:

        data_args.reason_seg_data = val_data
